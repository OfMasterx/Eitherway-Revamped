...
import { PreviewEnhanced } from './PreviewEnhanced';
...
export const Workbench = memo(({ chatStarted, isStreaming }: WorkspaceProps) => {
  ...
  // Get sessionId from workbench store (set by Chat component)
  useEffect(() => {
    const id = (workbenchStore as any).sessionId || null;
    setSessionId(id);
  }, []);
          ...
          >
            <div className="h-full flex flex-col bg-eitherway-elements-background-depth-2 border border-eitherway-elements-borderColor shadow-sm rounded-lg overflow-hidden">
              ...
              <div className="relative flex-1 overflow-hidden">
                ...
                >
                  <PreviewEnhanced files={files} sessionId={sessionId} />
                </View>
              </div>
            </div>
          </div>
